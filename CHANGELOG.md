...
## [1.0.2] - 2025-11-27
### Fixed
- Fixed `Call to undefined method App\Http\Controllers\Admin\LoginController::showLoginForm()` error.
- Fixed `ArgumentCountError` in `InstallCommand::createControllers()` method call.
